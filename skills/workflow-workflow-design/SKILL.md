...
- **Business Analyst** — clarifies process intent and steps (invoke for Step 1–3)
...
A complete `workflow-<name>/SKILL.md` file that can be immediately loaded by the Delivery Manager and executed by designated agents without additional clarification.

Acceptance criteria:
- All 10 steps completed
- Review checklist in Step 10 fully passed
- Skill file committed to the `skills/` directory
- Delivery Manager agent updated to list the new workflow skill
