...
name: core-database
category: core
description: Database schema design rules — normalization, column types, indexing, CakePHP ORM naming, and migration safety.
worker-hint: lead
---
...
- For full rules, column type guide, and migration safety patterns, see [reference.md](reference.md)
