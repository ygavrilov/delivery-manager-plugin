---
name: framework-cakephp
category: framework
type: rule
description: CakePHP architecture patterns and conventions — layering, naming, response shape, auth, enums, and migration rules. Use when implementing CakePHP code, structuring controllers/models, shaping responses, or handling auth and migrations.
worker-hint: senior
---
